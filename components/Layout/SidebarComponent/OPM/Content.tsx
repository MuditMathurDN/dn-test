...
const Card: React.FC<CardProps> = ({ index, text, heading, icon, gif }) => {
    ...
    return <div ref={ref} className='bg-[#fafafa]   drop-shadow-[0px_-1px_4px_rgba(0,0,0,0.35)]  md:sticky top-10  py-24 px-10 grid grid-cols-1 md:grid-cols-[20%_50%_30%] gap-x-4 gap-y-6'>
...
const Content: React.FC<Props> = ({ posts }) => {
    ...
    return (<div className='font-[poppins] mt-72'>
        <div className='bg-black px-8'>
            ...
            <div className='text-md my-6 text-white'>
            ...
            <div className='text-[#c4c4c4] my-10 text-2xl'>
            ...
            <div className='noselect custom-font-IBMPlexMono grid mb-16 grid-cols-1 text-xl gap-y-8 gap-x-8 md:grid-cols-2'>
                <div className={`cursor-pointer 
                 ${FunctionContextData.activeTabOPM === 0 ? 'text-black bg-primaryYellow border-primaryYellow' : 'text-white border-white'} 
                 border-2 py-6 px-4 
                ...
                <div className={`cursor-pointer 
                 ${FunctionContextData.activeTabOPM === 1 ? ' text-black bg-primaryYellow border-primaryYellow' : 'text-white border-white'}
                  border-2 py-6 px-4 
                 hover:bg-primaryYellow hover:border-primaryYellow hover:text-black
                  duration-300`}
        ...
        <div ref={featureRef} id="features" className='bg-black my-16 space-y-8'>
            <FeatureGallery />
        </div>
