...
export default function CourousalV2({featureList}:{
  ...
  return (
    ...
    >
      ...
      <div className='hidden lg:flex my-auto 
        ...
        <motion.img
          ...
          className='h-[90%] -mt-16 max-w-[50vw]  z-50 object-contain  bg-cover'
        ...
        ' >
          <div
          className='absolute -bottom-2 -left-[3px]  
      ...
      <div className='space-y-8 lg:space-y-[2vw] xl:space-y-[1.7vw] 
        ...
        <div
        className='place-self-start cursor-pointer'
    ...
    <div className="w-full md:w-[80%] space-y-4">
      <h2
      className='text-[14px] md:text-[32px] font-bold text-primaryBlue'
