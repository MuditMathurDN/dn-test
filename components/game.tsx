...
let Game = () => {
	...
	return (
		<div style={{ boxShadow: `0px 0px 8px rgba(0, 0, 0, 0.25)` }}>
			<div
				onScroll={(e) => {
					// @ts-ignore
			...
			>
				...
				>
					<div style={{ fontSize: 21 }}>
						...
						<span className="text-primaryBlue font-semibold" >DataNeuron</span>{" "}
						Pipeline.
					</div>
					{gameData.map((data) => {
						return (
								...
								>
									<div
										...
										style={{
											...
											transform: `translateY(${data.show ? "0" : "-50px"
												})`,
										}}
									>
										<div
			...
			<div className="flex justify-between">
				<img
					...
					src={interaction === false ? "/play_active.svg" : "/play.svg"}
